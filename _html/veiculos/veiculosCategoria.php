...
<?php
include_once ('../_php/verificaruser.php');
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../_css/veiculos/veiculosCategoria.css">
...
<body>
    ...
    <div class="anuncios">
        <div class="flex-container">
            <div>
                <img class="fotocarro" src="../_img/onix.jpg" alt="">
                <div>
            ...
            <div>
                <img class="fotocarro" src="../_img/fitjpg.jpg" alt="">
                <div>
                    <li>Honda Fit</li>
                    <li>2020</li>
                    <li>Leilão: Em andamento</li>
            ...
            <div>
                <img class="fotocarro" src="../_img/etios.jpg" alt="">
                <div>
                    <li>2018</li>
                    <li>sei lá</li>
                    <li>sei lá 2</li>
            ...
            <div>
                <img class="fotocarro" src="../_img/hb20.jpg" alt="">
                <div>
                    <li>2020</li>
                    <li>sei lá</li>
                    <li>sei lá 2</li>
            ...
            <div>
                <img class="fotocarro" src="../_img/march.jpeg" alt="">
                <div>
                    <li>2020</li>
                    <li>sei lá</li>
                    <li>sei lá 2</li>
