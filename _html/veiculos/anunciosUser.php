...
<head>
    ...
    <link rel="stylesheet" href="../../_css/veiculos/anunciosUser.css">
...
<nav class="menu">
			<ul>
				<li><img style="position: absolute; margin-top:3px; width:35px; margin-left: -35px;"  src="data:image/png;base64,"><a href="#">Anunciar</a>
                    <ul>
                    <li><a href="../veiculos/cadastrarveiculo.php">Cadastrar veiculo</a></li>
                        <li><a href="../veiculos/anunciosUser.php">Meus anuncios</a></li>
                    </ul>
                </li>
    ...
    <div class="anuncios">
        ...
        <?php
            for($cont = 0; $cont < count($dados); $cont++){
                ?>
                    <div class="divFoto">
                        <img class="fotocarro" src="<?php echo $dados[$cont]->path_imagem ?>" alt="">
                        <ul>
                            ...
                            <button class="btInfo"><a target="_blank" href="./veiculo.php?veiculo_id=<?php echo $dados[$cont]->veiculo_id;?>">Ver mais</a></button>
                        </ul>
                    </div>
