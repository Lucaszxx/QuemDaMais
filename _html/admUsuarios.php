...
<link rel="stylesheet" href="../_css/admUsuarios.css">
...
<div class="anunciosUser">
            <h2 id="tUsuario">Usuarios</h2>
                <div class="box2">
                    <ul class="dadosUsuario">
                    <a href="#"><img class="imgVeiculo" src="../_img/perfil1.jpg" alt=""></a>
                        <div class="divVisualizarUsuario">
                            <a class="visualizarUsuario" href="#">Usuario: Glauber Souza</a>
                        </div>
                    </ul>
                    <ul class="dadosUsuario">
                    <a href="#"><img class="imgVeiculo" src="../_img/perfil2.jpg" alt=""></a>
                        <div class="divVisualizarUsuario">
                            <a class="visualizarUsuario" href="#">Usuario: Thamy Freitas</a>
                        </div>

                    </ul>
                    <ul class="dadosUsuario">
                    <a href="#"><img class="imgVeiculo" src="../_img/perfil3.jpg" alt=""></a>
                        <div class="divVisualizarUsuario">
                            <a class="visualizarUsuario" href="#">Usuario: Evellyn Silva</a>
                        </div>
                    </ul>
                    <ul class="dadosUsuario">
                    <a href="#"><img class="imgVeiculo" src="../_img/perfil4.jpg" alt=""></a>
                        <div class="divVisualizarUsuario">
                            <a class="visualizarUsuario" href="#">Usuario: Cleyton Gomes</a>
                        </div>
                    </ul>
                    <ul class="dadosUsuario">
                    <a href="#"><img class="imgVeiculo" src="../_img/perfil5.jpeg" alt=""></a>
                        <div class="divVisualizarUsuario">
                            <a class="visualizarUsuario" href="#">Usuario: Fernando Moura</a>
                        </div>
                    </ul>
                    <ul class="dadosUsuario">
                    <a href="#"><img class="imgVeiculo" src="../_img/perfil6.jpeg" alt=""></a>
                        <div class="divVisualizarUsuario">
                            <a class="visualizarUsuario" href="#">Usuario: Clara Lopes</a>
                        </div>
                    </ul>
                </div>
</div>
