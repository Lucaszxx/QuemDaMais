...
<head>
    ...
    <link rel="stylesheet" href="../_css/admVeiculos.css">
...
<ul>
    ...
    <div class="anunciosUser">
        <div class="box">
            <h2 class="garagem">Veiculos Cadastrados</h2>
                <div class="box2">
                    <ul class="dadosVeiculo">
                    <a href="#"><img class="imgVeiculo" src="../_img/fitjpg.jpg" alt=""></a>
                        <div class="divVisualizarVeiculo">
                            <a class="visualizarVeiculo" href="#">Anunciante: EmailAnunciante@gmail.com</a>
                        </div>
                    </ul>
                    <ul class="dadosVeiculo">
                    <a href="#"><img class="imgVeiculo" src="../_img/carro1.jpg" alt=""></a>
                        <div class="divVisualizarVeiculo">
                            <a class="vizuarlizarVeiculo" chref="#">Anunciante: EmailAnunciante@gmail.com</a>
                        </div>

                    </ul>
                    <ul class="dadosVeiculo">
                    <a href="#"><img class="imgVeiculo" src="../_img/onix.jpg" alt=""></a>
                        <div class="divVisualizarVeiculo">
                            <a class="vizuarlizarVeiculo" chref="#">Anunciante: EmailAnunciante@gmail.com</a>
                        </div>
                    </ul>
                    <ul class="dadosVeiculo">
                    <a href="#"><img class="imgVeiculo" src="../_img/march.jpeg" alt=""></a>
                        <div class="divVisualizarVeiculo">
                            <a class="vizuarlizarVeiculo" chref="#">Anunciante: EmailAnunciante@gmail.com</a>
                        </div>
                    </ul>
