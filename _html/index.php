...
<nav class="menu">
    ...
    <div class="anuncios">
        <div class="flex-container">
            <ul class="">
                <img class="fotocarro" src="<?php echo $imgVeiculo ?>" alt="">
                <li>Carro 1</li>
                <li><?php $nomeCarro ?></li>
            </ul>
        </div>
